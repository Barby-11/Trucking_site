...
export default function TalkHome() {
  ...
  <Stack>
    <CardBody>
      ...
      fontWeight={'bold'} 
      mt={2}>
        Accident on Highway 16 north bay <span style={{marginTop:"5px",marginLeft:"2rem",color:"blue"}}><BsBookmarks/></span>
    </Text>
...
<Card
  ...
  <Stack>
    <CardBody>
      ...
      fontWeight={'bold'} 
      mt={2}>
       San Francisco sunlight <span style={{marginTop:"5px",marginLeft:"2rem",color:"blue"}}><BsBookmarks/></span>
    </Text>
      <Text py='2' color={'blackAlpha.600'}>
...
<Card
  ...
  <Stack>
    <CardBody>
      ...
      fontWeight={'bold'} 
      mt={2}>
        Quake Ohio <span style={{marginTop:"5px",marginLeft:"2rem",color:"blue"}}><BsBookmarks/></span>
    </Text>
      <Text py='2' color={'blackAlpha.600'}>
